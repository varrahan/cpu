module top (
    ...
    decode_execute_register u_id_ex (
        ...
        .mem_write_in (id_mem_write), .reg_write_in (id_reg_write), .branch_in    (id_branch),
        .jal_in       (id_jal),       .jalr_in      (id_jalr),      .funct3_in    (id_funct3),
        ...
        .mem_write_out(ex_mem_write), .reg_write_out(ex_reg_write), .branch_out   (ex_branch),
        .jal_out      (ex_jal),       .jalr_out     (ex_jalr),      .funct3_out   (ex_funct3),
        .lui_out      (ex_lui),       .auipc_out    (ex_auipc)
    );
    ...
    execute_memory_register u_ex_mem (
        .clk              (clk),
        .rst_n            (rst_n),
        .flush            (1'b0),
        .alu_result_in    (ex_alu_result_final),
        .rs2_data_in      (fwd_rs2),
        .rd_in            (ex_rd),
    ...
    memory_writeback_register u_mem_wb (
        .clk           (clk),
        .rst_n         (rst_n),

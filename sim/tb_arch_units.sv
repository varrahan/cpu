...
module tb_arch_units;
    ...
    logic [31:0] instr;
    hybrid_pkg::decode_t decoded;
    decoder dec (.instr, .decoded);

    logic [11:0] read_addr, commit_addr;
    logic read_write_intent, commit_valid, retire, trap_enter, csr_mret, csr_sret;
    logic irq_m_software, irq_m_timer, irq_m_external;
    logic irq_s_software, irq_s_timer, irq_s_external;
    logic [31:0] commit_data, trap_pc, trap_cause, trap_tval;
    logic fp_flags_valid, fp_dirty;
    logic [4:0] fp_flags;
    ...
    task expect_decode;
        ...
        begin
            instr = value;
            #1;
            if (decoded.illegal !== expected_illegal)
